        ...
        <div className="py-12 md:py-20">
          ...
          >
            ...
            <p className="text-xl text-gray-400">
              Here are the highlights of some features Galvr offer.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                ...
                data, beyond the predefined metrics exported from Kubernetes by
                default.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">OpenTelemetry Compliance</h4>
              <p className="text-lg text-gray-400 text-center">
                Galvr is in compliance with the OpenTelemetry specification, and
                able to handle all different types of metrics data (e.g. sum,
                gauge and histogram).
              </p>
            </div>
